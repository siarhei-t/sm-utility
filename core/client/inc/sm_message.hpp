...
public:
    ...
    void msgCustom(std::vector<std::uint8_t>& buffer,
                   const std::uint8_t func, 
                   const std::vector<std::uint8_t>& data,
                   const std::uint8_t addr = 0);
    
    void msgWriteFileRecord(std::vector<std::uint8_t>& buffer,
                            const std::uint16_t file_id,
                            const std::uint16_t record_id,
                            const std::vector<std::uint8_t>& record_data,
                            const std::uint8_t addr = 0);

    void msgReadFileRecord(std::vector<std::uint8_t>& buffer,
                           const std::uint16_t file_id,
                           const std::uint16_t record_id,
                           const std::uint16_t length,
                           const std::uint8_t addr = 0);

    void msgWriteRegister(std::vector<std::uint8_t>& buffer, 
                          const std::uint16_t reg,
                          const std::uint16_t value,
                          const std::uint8_t addr = 0);

    void msgReadRegisters(std::vector<std::uint8_t>& buffer,
                          const std::uint16_t reg,
...
private:
    ...
    void createMessage(std::vector<std::uint8_t>& buffer,
                       const std::uint8_t func,
                       const std::vector<std::uint8_t>& data,
                       const std::uint8_t addr = 0);
